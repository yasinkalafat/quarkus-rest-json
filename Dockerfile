...
COPY *.jar /deployments/sidekick-agent-bootstrap.jar

EXPOSE 8080
USER 185

ENV SIDEKICK_AGENT_APPLICATION_NAME=quarkus-demo-app
...
ENTRYPOINT [ "java", "-javaagent:sidekick-agent-bootstrap.jar", "-jar", "/app/quarkus-run.jar" ]